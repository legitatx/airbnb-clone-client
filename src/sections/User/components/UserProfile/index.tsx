...
export const UserProfile = ({
  ...
  const [disconnectStripe, { loading }] = useMutation<DisconnectStripeData>(
    DISCONNECT_STRIPE,
    {
      ...
      onError: () => {
        displayErrorMessage(
          "Sorry! We weren't able to disconnect your Stripe account. Please try again later!"
        );
      },
    }
  );
  ...
  const additionalDetails = user.hasWallet ? (
    <Fragment>
      ...
      <Paragraph type="secondary">
        ...
        booking any listings that you might have already created.
      </Paragraph>
    </Fragment>
  ) : (
    <Fragment>
      <Paragraph>
        Interested in becoming a host? Register your Stripe account to get
        started.
      </Paragraph>
      <Button
        type="primary"
      ...
      <Paragraph>
        ...
        to help transfer your funds in a secure and trusted manner.
      </Paragraph>
    </Fragment>
  );
